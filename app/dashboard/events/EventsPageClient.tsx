...
function AxisChart({
  ...
  const scaleY = (value: number) =>
    topPad +
    innerHeight -
    ((value - minValue) / Math.max(maxValue - minValue, 1)) * innerHeight;
              ...
              {loading ? (
                ...
                <div className="mt-6 space-y-6">
                  <AxisChart
                    ...
                    subtitle={`Y-axis: mm/hr intensity • Peak observed: ${fmt(
                      rainMax,
                      2
                    )} mm/hr`}
                    values={rainValues}
                  ...
                  <AxisChart
                    title="Flood Depth"
                    subtitle={`Y-axis: cm depth • Peak observed: ${fmt(
                      floodMax,
                      1
                    )} cm`}
                    values={floodValues}
                    ...
                    <div className="mt-4 grid grid-cols-2 gap-3 text-sm">
                      ...
                      <div>
                        ...
                        <div className="mt-1 font-semibold text-zinc-900">
                          {durationText(event.started_at, event.ended_at, nowMs)}
                        </div>
                      </div>
                      <div>
