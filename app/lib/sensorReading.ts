...
export function extractRainMmHr(
  point: SensorPoint | null | undefined
): number {
  if (!point) return 0;
...
export function isDepthTrusted(
  point: SensorPoint | null | undefined
): boolean {
...
export function extractFloodDepthCm(
  point: SensorPoint | null | undefined
): number {
  if (!point) return 0;
...
export function extractDryDistanceCm(
  point: SensorPoint | null | undefined
): number | null {
  if (!point) return null;
...
export function extractStableWaterCm(
  point: SensorPoint | null | undefined
): number | null {
  if (!point) return null;
...
export function extractBatteryPercentage(
  point: SensorPoint | null | undefined
): number | null {
  if (!point) return null;
